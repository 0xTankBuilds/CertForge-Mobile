package com.certforge.app.data.remote
...
data class CertificationsResponse(
    @SerialName("certifications") val certifications: List<CertificationDto>
)
...
interface SyncApi {
    ...
    suspend fun getManifest(@Query("certId") certId: String = "az-104"): ManifestResponse

    @GET("api/sync/domains")
    suspend fun getDomains(@Query("certId") certId: String = "az-104"): DomainsResponse

    @GET("api/sync/questions")
    suspend fun getQuestions(
        @Query("since") since: Long? = null,
        @Query("certId") certId: String = "az-104"
    ): QuestionsResponse

    @GET("api/sync/study-guides")
    suspend fun getStudyGuides(
        @Query("since") since: Long? = null,
        @Query("certId") certId: String = "az-104"
    ): StudyGuidesResponse

    @GET("api/sync/articles")
    suspend fun getArticles(@Query("certId") certId: String = "az-104"): ArticlesResponse
