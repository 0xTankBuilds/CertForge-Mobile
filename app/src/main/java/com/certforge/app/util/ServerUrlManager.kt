package com.certforge.app.util
...
class ServerUrlManager(context: Context) {
    ...
    fun getSelectedCertId(): String = prefs.getString(KEY_SELECTED_CERT_ID, "az-104") ?: "az-104"

    fun setSelectedCertId(certId: String) {
        prefs.edit().putString(KEY_SELECTED_CERT_ID, certId).apply()
    }
    ...
    companion object {
        private const val PREFS_NAME = "certforge_server_prefs"
        private const val KEY_SERVER_URL = "server_url"
        private const val KEY_PROFILE_ID = "profile_id"
        private const val KEY_PROFILE_NAME = "profile_name"
        private const val KEY_LAST_SYNC = "last_sync_timestamp"
        private const val KEY_LAST_PROGRESS_SYNC = "last_progress_sync_timestamp"
        private const val KEY_SELECTED_CERT_ID = "selected_cert_id"
    }
}
